...
package com.cloudminds.kafka.jdbc.deserialization;
 ...
 */
@PublicEvolving
public class DeserializationStringSchema implements DeserializationSchema<String>, SerializationSchema<String> {
     ...
     */
    public DeserializationStringSchema() {
     ...
     */
    public DeserializationStringSchema(Charset charset) {
