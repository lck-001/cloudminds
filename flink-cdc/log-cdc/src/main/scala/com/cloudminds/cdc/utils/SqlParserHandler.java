...
//    private static List excludeColumns = Arrays.asList("db","table","bigdata_method","event_time");
     ...
     * @return 返回列
     */
    public static List<String> getSelectColumns(String singleSql, HashMap<String, String> schemaMap) throws Exception{
        if (singleSql == null) {
    ...
    private static List<String> convertColumn(String singleSql,HashMap<String, String> schemaMap) throws Exception {
        List<String> columns = new ArrayList<String>();
        List<String> tables = getSelectTables(singleSql);
        String schemaStr = schemaMap.get(tables.get(0));
