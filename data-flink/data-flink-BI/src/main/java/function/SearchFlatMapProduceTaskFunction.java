...
public class SearchFlatMapProduceTaskFunction extends RichFlatMapFunction<List<WorkOrderData>, WorkOrderData> {
    ...
    @Override
    public void flatMap(List<WorkOrderData> workOrderDatas, Collector<WorkOrderData> collector) throws Exception {
        params.put("equipmentIdList", RequestConf.EQUIPMENT_ID_LIST);
