    ...
    public static <T> SinkFunction getJdbcSink(String sql) {
        SinkFunction<T> sink = JdbcSink.<T>sink(
                ...
                new JdbcConnectionOptions.JdbcConnectionOptionsBuilder()
                        .withUrl(RequestConf.CLICKHOUSE_URL)
                        .withDriverName(RequestConf.CLICKHOUSE_DRIVER)
                        .withUsername(RequestConf.CLICKHOUSE_USERNAME)
                        .withPassword(RequestConf.CLICKHOUSE_PASSWORD)
//                        .withUrl("jdbc:clickhouse://172.16.32.96:9090/")
//                        .withDriverName(HttpConf.CLICKHOUSE_DRIVER)
