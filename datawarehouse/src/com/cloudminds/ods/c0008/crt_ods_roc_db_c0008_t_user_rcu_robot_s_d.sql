-- 251环境 cdmods.ods_roc_db_c0008_t_user_rcu_robot_s_d user-rcu-robot关联信息表
create external table cdmods.ods_roc_db_c0008_t_user_rcu_robot_s_d(
...
comment '251环境 user-rcu-robot关联信息表 roc.t_user_rcu_robot'
