-- cdmods.ods_crio_db_c0026_t_event_i_d 机器人事件信息表
create external table cdmods.ods_crio_db_c0026_t_event_i_d(
...
STORED AS parquet
location '/data/cdmods/ods_crio_db_c0026_t_event_i_d';