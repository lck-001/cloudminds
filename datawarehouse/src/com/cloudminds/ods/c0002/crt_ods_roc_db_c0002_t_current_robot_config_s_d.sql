-- cdmods.crt_ods_roc_db_c0002_t_current_robot_config_s_d roc帐号当前生效的配置表
create external table cdmods.ods_roc_db_c0002_t_current_robot_config_s_d(
...
comment '帐号当前生效的配置表roc.t_current_robot_config'
