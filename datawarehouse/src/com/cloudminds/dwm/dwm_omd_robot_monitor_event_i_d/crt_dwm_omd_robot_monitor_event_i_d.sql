...
create external table cdmdwm.dwm_omd_robot_monitor_event_i_d
(
    event_id                string comment '事件ID',
    event_type_id           string comment '事件类型ID',
    event_type_name_cn      string comment '事件类型中文名',
    event_type_name_en      string comment '事件类型英文名',
    rcu_id                  string comment 'RCU编码',
    device_id               string comment 'cross 设备ID ',
    event_time              string comment '事件时间',
    event_level             int COMMENT '事件级别',
    event_details           string COMMENT '事件详情',
    ext_data                string COMMENT '扩展字段',
    event_pic_url           string COMMENT '事件图片URL',
    robot_location_info     string COMMENT '事件发生时机器人位置信息',
