create external table cdmdwm.dwm_svo_anno_label_event_i_d(
    ...
    label_type_id string comment '标签类型ID ，暂时 1.听写错误/回答正确 2. 听写错误/回答错误 3. 听写正确/回答错误 4.HA介入 5. 杂音 6. 断句错误,回答错误 7. 人工巡检 8 听写和回答都没问题 9 其他 10 断句错误回答正确',
