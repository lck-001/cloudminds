...
with t as (
    SELECT 
        ...
        correct_text,
        submit_time
    from cdmdwd.dwd_cms_svo_anno_label_event_a_d
    where 
...
result_t as (
    SELECT 
        ...
        o.correct_text as correct_text,
    ...
    left JOIN (
        ...
        from (
            ...
            and
                to_date(nlu_event_time) >= date_sub('${e_dt_var}', 30)
        ) t
    ) as a on o.question_id = a.question_id where a.rnk = 1
)

insert overwrite table cdmdwm.dwm_svo_anno_label_event_i_d partition(dt) 
select 
    *,
