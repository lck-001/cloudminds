...
--          robot dim
    ...
    from  cdmdwd.dwd_crio_tmd_cleanx_task_log_a_d t1
             left join (
        select
            tenant_id,
            tenant_name,
...
--              where dt = '2021-09-18' and
        ...
        where dt = date_sub(current_date,1)
             ...
             left join cdmdim.dim_umd_industry_a_d t5 on t2.industry_id = t5.industry_id left join cdmdim.dim_tmd_task_sh_d t6 on t1.task_id=t6.task_id
...
insert overwrite table cdmdwm.dwm_tmd_cleanx_task_log_a_d
