...
with  union_dim as (
    select
        t1.programme_id as task_id,
        t1.project_code,
        t1.project_name,
        t1.event_type,
        t1.event_type_name,
        t1.task_exec_start_time,
        t1.task_plan_end_time,
        t1.plan_repeat_times,
        t1.plan_point_tasks,
        t1.event_time as start_event_time,
        if(t7.task_task_id='',0,1) as is_finish,
        t7.task_exec_stop_time,
        t7.running_time,
        t7.finish_times,
        t7.mileage,
        t7.finish_point_tasks,
        t7.driven_mileage,
        t7.avoidance_times,
        t7.tts_play_times,
        t7.average_mileage,
        t7.average_battery,
        t7.event_time as stop_event_time,
        t1.k8s_env_name,
        --            customer dim
...
--          robot dim
    ...
    from  cdmdwd.dwd_crio_tmd_patrol_start_a_d t1 where programme_id!=''
             left join (
        select
            tenant_id,
            tenant_name,
...
--              where dt = '2021-09-18'
        ...
        select
            ...
            pub_time,
            event_time,
        from cdmdwm.dwm_tmd_patrol_stop_a_d
        where task_task_id != ''
    ) t7 on t1.programme_id = t7.task_task_id
...
insert overwrite table cdmdwm.dwm_tmd_patrol_start_a_d
