-- cdmdwm.dwm_vmd_robot_detect_video_info_i_d 机器人采集的视频信息
create external table cdmdwm.dwm_vmd_robot_detect_video_info_i_d (
...
stored as parquet
location '/data/cdmdwm/dwm_vmd_robot_detect_video_info_i_d';