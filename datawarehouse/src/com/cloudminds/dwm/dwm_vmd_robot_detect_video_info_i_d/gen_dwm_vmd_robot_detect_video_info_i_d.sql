...
--          robot dim
        ...
        t1.dt
    from (select * from cdmdwd.dwd_harix_vmd_robot_detect_video_info_i_d where dt>=date_sub('${s_dt_var}',1) and dt<='${e_dt_var}') t1
             left join (
        select
            tenant_id,
            tenant_name,
...
insert overwrite table cdmdwm.dwm_vmd_robot_detect_video_info_i_d partition(dt)
