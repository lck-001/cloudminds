...
insert overwrite table cdmdws.dws_vmd_robot_detect_image_info_i_d partition(dt)
    select
      type_name,
      k8s_env_name,
      ...
      dt
    from cdmdwm.dwm_vmd_robot_detect_image_info_i_d where dt>=date_sub('${s_dt_var}',1) and dt<='${e_dt_var}'
