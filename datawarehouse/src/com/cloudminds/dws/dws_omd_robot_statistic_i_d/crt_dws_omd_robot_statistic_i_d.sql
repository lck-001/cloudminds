...
create external table cdmdws.dws_omd_robot_statistic_i_d
(
...
--            customer dim
    ...
    event_date string comment '事件发生的日期',
    robot_online_time int comment '机器人在线时长',
    robot_offline_times int comment '机器人下线次数',
    robot_online_times int comment '机器人上线次数',
