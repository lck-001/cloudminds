-- cdmdwd.dwd_harix_cmd_rcu_record_i_d 机器人RCU 录制声音
create external table cdmdwd.dwd_harix_cmd_rcu_record_i_d (
...
stored as parquet
location '/data/cdmdwd/dwd_harix_cmd_rcu_record_i_d';