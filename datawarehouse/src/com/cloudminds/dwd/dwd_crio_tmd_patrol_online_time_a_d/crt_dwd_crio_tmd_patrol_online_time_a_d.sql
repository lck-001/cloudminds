-- cdmdwd.dwd_crio_tmd_patrol_online_time_a_d 巡逻机器人任务在线时长
create external table cdmdwd.dwd_crio_tmd_patrol_online_time_a_d (
    ...
    online_time double comment '在线时间（小时）',
...
stored as parquet
location '/data/cdmdwd/dwd_crio_tmd_patrol_online_time_a_d';