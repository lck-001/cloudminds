...
start_table as (
    select
        ...
        nvl(plan_end_time,'') as task_plan_end_time,
        ...
        event_time
    from patrol_log
    lateral view json_tuple(description,'taskId', 'taskName', 'projectCode','projectName','startTime','planEndTime','planRepeatTimes','planPointTasks','battery') a
    as programme_id,programme_name,project_code_desc,project_name_desc,start_time,plan_end_time,plan_repeat_times,plan_point_tasks,current_battery
)
insert overwrite table cdmdwd.dwd_crio_tmd_patrol_start_a_d
    select
        oid,
        event_id,
        robot_id,
