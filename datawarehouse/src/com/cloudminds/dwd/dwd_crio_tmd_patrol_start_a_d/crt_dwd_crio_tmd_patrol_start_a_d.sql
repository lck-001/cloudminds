-- cdmdwd.dwd_crio_tmd_patrol_start_a_d 巡逻机器人任务start事件
create external table cdmdwd.dwd_crio_tmd_patrol_start_a_d (
    ...
    task_plan_end_time string comment '本次任务停止时间,存在数据没有年月日,研发未填写和循环任务这两种情况下,没有年月日,通过入库时间填充对应的年月日',
...
stored as parquet
location '/data/cdmdwd/dwd_crio_tmd_patrol_start_a_d';