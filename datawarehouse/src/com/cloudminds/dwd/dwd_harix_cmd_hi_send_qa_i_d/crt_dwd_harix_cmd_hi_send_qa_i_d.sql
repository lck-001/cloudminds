-- cdmdwd.dwd_harix_cmd_hi_send_qa_i_d hi发送qa(question&answer\action)到harix
create external table cdmdwd.dwd_harix_cmd_hi_send_qa_i_d (
...
comment 'hi发送qa(question&answer/action)到harix'
partitioned by(dt string comment 'dt分区字段')
stored as parquet
location '/data/cdmdwd/dwd_harix_cmd_hi_send_qa_i_d';